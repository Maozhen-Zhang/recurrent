...
class ImageHelper(Helper):
    ...
    def load_data(self):
        ...
        self.train_dataset = datasets.CIFAR10('~/dataset/CIFAR-10', train=True, download=True,
                                         transform=transform_train)

        self.test_dataset = datasets.CIFAR10('~/dataset/CIFAR-10', train=False, transform=transform_test)
